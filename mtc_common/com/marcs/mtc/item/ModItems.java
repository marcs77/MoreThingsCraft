...
public class ModItems {
	...
	public static void initItems(){
		...
		cobaltPickaxe = new ItemMTCPickaxe(ItemIds.COBALT_PICKAXE, COBALT).setUnlocalizedName(Strings.COBALT_PICKAXE_NAME);
		...
		titaniumPickaxe = new ItemMTCPickaxe(ItemIds.TITANIUM_PICKAXE, TITANIUM).setUnlocalizedName(Strings.TITANIUM_PICKAXE_NAME);
		...
		magnetitePickaxe = new ItemMTCPickaxe(ItemIds.MAGNETITE_PICKAXE, MAGNETITE).setUnlocalizedName(Strings.MAGNETITE_PICKAXE_NAME);
